...
@ObjectClassDefinition(
        name = "Mysite - JSON Creator Scheduler Configuration",
...
public @interface JSONCreatorConfig {
    ...
    public String schedulerName() default "Mysite_JSON_Creator";
    ...
    public String getSiteParent() default "/content/mysite";
}
