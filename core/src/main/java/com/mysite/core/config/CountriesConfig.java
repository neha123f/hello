...
@ObjectClassDefinition(name="Mysite - Countries JSON configuration",
...
public @interface CountriesConfig {
    ...
    public String jsonPath() default "/content/mysite/us";
    ...
    public String authorsPath() default "/content/mysite/us";
}